...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label->setGeometry(QRect(10, 10, 731, 711));
        label_2 = new QLabel(centralwidget);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(830, 80, 31, 20));
        label_3 = new QLabel(centralwidget);
        label_3->setObjectName(QString::fromUtf8("label_3"));
        label_3->setGeometry(QRect(830, 130, 31, 20));
        label_4 = new QLabel(centralwidget);
        label_4->setObjectName(QString::fromUtf8("label_4"));
        label_4->setGeometry(QRect(830, 190, 31, 20));
        label_5 = new QLabel(centralwidget);
        label_5->setObjectName(QString::fromUtf8("label_5"));
        label_5->setGeometry(QRect(820, 250, 31, 20));
        x1 = new QTextEdit(centralwidget);
        x1->setObjectName(QString::fromUtf8("x1"));
        x1->setGeometry(QRect(860, 80, 131, 31));
        y1 = new QTextEdit(centralwidget);
        y1->setObjectName(QString::fromUtf8("y1"));
        y1->setGeometry(QRect(860, 130, 131, 31));
        x2 = new QTextEdit(centralwidget);
        x2->setObjectName(QString::fromUtf8("x2"));
        x2->setGeometry(QRect(860, 180, 131, 31));
        y2 = new QTextEdit(centralwidget);
        y2->setObjectName(QString::fromUtf8("y2"));
        y2->setGeometry(QRect(860, 240, 131, 31));
        pushButton = new QPushButton(centralwidget);
        pushButton->setObjectName(QString::fromUtf8("pushButton"));
        pushButton->setGeometry(QRect(870, 280, 121, 41));
        pushButton_2 = new QPushButton(centralwidget);
        pushButton_2->setObjectName(QString::fromUtf8("pushButton_2"));
        pushButton_2->setGeometry(QRect(870, 350, 121, 41));
        pushButton_3 = new QPushButton(centralwidget);
        pushButton_3->setObjectName(QString::fromUtf8("pushButton_3"));
        pushButton_3->setGeometry(QRect(870, 460, 121, 41));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_2->setText(QCoreApplication::translate("MainWindow", "Change Color", nullptr));
